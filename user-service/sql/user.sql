...
CREATE TABLE `menu`  (
  `men_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '编号',
...
CREATE TABLE `role`  (
  `rol_id` int(12) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '编号',
...
CREATE TABLE `user`  (
  `use_id` int(12) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '编号',
...
CREATE TABLE `user_role`  (
  `rol_id` int(12) UNSIGNED NOT NULL DEFAULT 0 COMMENT '角色编号',
